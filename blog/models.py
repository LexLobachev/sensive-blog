...
class PostQuerySet(models.QuerySet):
    ...
    def fetch_with_comments_count(self):
        ...
        posts_ids_and_comments_count = posts_with_comments.values_list('id', 'comments_count')
        count_for_id = dict(posts_ids_and_comments_count)
    ...
    def fetch_with_posts_count(self):
        fetched_with_posts_count = self.prefetch_related(
            Prefetch('tags', queryset=Tag.objects.annotate(posts_count=Count('posts'))))

        return fetched_with_posts_count
